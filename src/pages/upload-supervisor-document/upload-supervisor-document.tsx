...
const UploadSupervisorDocument: React.FC = () => {
  const navigate = useNavigate();

  useEffect(() => {

    console.log('UploadSupervisorDocument - Cleaning up navigation flags');
    sessionStorage.removeItem('allowUploadSupervisorDocumentNavigation');
  ...
  const steps = [
    { number: 1, icon: "bi-person", title: "Supervisor Information", active: false },
    { number: 2, icon: "bi-upload", title: "Upload", active: true }
  ];

  return (
    <div className="upload-supervisor-document-container min-vh-100 bg-light" style={{ paddingTop: '80px' }}>
        ...
        <Card className="border-0 shadow-sm mb-1 mx-auto" style={{ width: '95%' }}>
          <Card.Body className="p-1">
            <div className="d-flex align-items-center justify-content-between">
              <h5 className="mb-0 fw-semibold text-primary text-center w-100">Upload Documents - Supervisor Registration</h5>
            </div>
      ...
      <style>{`
        .upload-supervisor-document-container {
        ...
        /* Progress bar full width for last step */
...
export default UploadSupervisorDocument;
